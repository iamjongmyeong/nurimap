...
- 상세 안의 review / add-rating child surface placement와 surface 경계도 이 문서의 일부로 해석한다.
...
- review 관련 design 해석은 이 문서로 흡수하고, 동작 정책은 selected spec과 user flow가 맡는다.
...
- review / add-rating 같은 detail submodule failure는 detail context 안에 국소화돼야 하며 selection/navigation을 깨면 안 된다.
...
- review / rating의 domain rule, API contract, 집계 정책 세부
