...
**Optional hybrid**
- If external familiarity matters, add a short note in governance docs such as: “`user-flows/` contains scenario, rule, and failure-flow docs that complement selected specs.” That gains discoverability without renaming the structure.
