...
describe('Place lookup and direct entry flow', () => {
  ...
  it('opens the desktop sidebar on the URL-entry screen first', async () => {
    ...
    expect(screen.getByRole('button', { name: '장소 정보 가져오기' })).toHaveClass('h-12', 'font-semibold')
    expect(screen.getByRole('button', { name: '직접 입력하기' })).toHaveClass('h-12', 'font-semibold')
